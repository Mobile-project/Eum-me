...
import rel.ljw.eummerelease.Model.RecordeService;
import rel.ljw.eummerelease.Model.memoItem;
import rel.ljw.eummerelease.Presenter.BackPressCloseHandler;
import rel.ljw.eummerelease.Presenter.FlagSingleton;
import rel.ljw.eummerelease.Presenter.RecordViewPagerAdapter;
...
//                .setRationaleMessage("구글 로그인을 하기 위해서는 주소록 접근 권한이 필요해요")
                .setDeniedMessage("If you reject permission,you can not use this service\n\nPlease turn on permissions at [Setting] > [Permission]").setPermissions(android.Manifest.permission.RECORD_AUDIO, android.Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE).check();
